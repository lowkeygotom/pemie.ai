...
const MCP_TOOL_SUMMARIES_EN: Record<McpToolName, string> = {
  ...
  list_user_stories: "User Stories filterable by status or epic.",
  create_user_story: "creates a User Story with narrative and criteria.",
  update_user_story: "updates a User Story's title, status, priority, or narrative.",
  ...
  get_user_story: "details for one User Story by id.",
  delete_user_story: "deletes a User Story and, unless requested otherwise, its Kanban card.",
