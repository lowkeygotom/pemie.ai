...
export default function BrainstormTab({ ws, proj }: { ws: string; proj: string }) {
  const { t, i18n } = useTranslation("project"); const [title, setTitle] = useState(""); const [selected, setSelected] = useState<string | null>(null); const navigate = useNavigate();
