...
/** Cadena rota: desvincular una HU de su épica (distinto de borrarla → TrashIcon). */
export function UnlinkIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M18.84 12.25l1.72-1.71a5.004 5.004 0 0 0-.12-7.07 5.004 5.004 0 0 0-6.95 0l-1.72 1.71" />
      <path d="M5.17 11.75l-1.72 1.71a5.004 5.004 0 0 0 .12 7.07 5.004 5.004 0 0 0 6.95 0l1.71-1.71" />
